...
- [x] Project summary panel.
- [x] Prompt input.
- [x] Conversational transcript.
- [x] Logs panel.
- [x] Slash commands.
- [x] Prompt history shortcuts.
...
- [x] Confidence score with reasons.
- [x] Simulation mode.
- [x] Diff preview.
